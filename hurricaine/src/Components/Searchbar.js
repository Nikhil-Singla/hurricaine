  ...
  const search = () => {
    ...
    axios.post('https://8656-23-228-186-78.ngrok-free.app/askgpt', createRequestBody())
      .then(function (response) {
        ...
        setSearchBarClass("absolute bottom-2 flex -ms-10");
  ...
  return (
    <div className="convo-box">
      <div className="overflow-y-scroll search-result-container" id="Scroller">
        ...
        {mapOpen ? <Map className="w-full" /> : <br />}
      </div>
            ...
            {!speechStart ?
              <div className="innerElement">
                {!browserSupportsSpeechRecognition ?
                  ...
                  :
                  <div className="innerElement" onClick={listen}>
      ...
      {!browserSupportsSpeechRecognition ? <div className="mt-2">Browser doesn't support speech recognition.</div> : ""}
    </div>
  )
}
