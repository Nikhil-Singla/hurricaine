...
const Searchbar = () => {
  ...
  const [searchBarClass, setSearchBarClass] = useState("flex justify-center align-middle mt-40 inputContainerGroup");
  ...
  return (
    <div className="convo-box">
      ...
      <div className={searchBarClass}>
        <div className="w-1/2 h-12 border-2 border-grey-500 rounded flex justify-end outerContainerInput">
